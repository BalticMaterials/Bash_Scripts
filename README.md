...
<h3 align="center">Ubuntu Post install script/h3>
<h4>
apt install git
git clone
</div>
...
```
$apt install git
$git clone https://github.com/BalticMaterials/Bash_Scripts/tree/main/preinstallUbuntuScript
$sudo bash basic_install.sh
```
### Prerequisites

installed Ubuntu Version 20 
